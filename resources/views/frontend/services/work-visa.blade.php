...
@section('content')
    ...
    <section class="section py-5">
        ...
        <div class="row px-5">
            <div class="col-md-12">
                <div class="container-fluid py-5 mt-4 shadow ml-4" style="border:3px solid #1d3f73!important;">
                    <h2 style="color: #d7a742 !important;" class="px-2 pb-2">Our Work Visa Services</h2>
                    <div class="d-flex">
                        <div class="col">
                            <h5 class="pt-2 px-2 pb-2 " style=" font-family: PT Sans, sans-serif;">We
