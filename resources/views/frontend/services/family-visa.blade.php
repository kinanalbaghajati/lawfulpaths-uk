                ...
                <div class="container mt-4 shadow rounded" style="border:3px solid #1d3f73!important;">
                    ...
                    <div class="d-flex">
                        <div class="col px-4 pb-4">
                            <h5>• Reuniting families is at the heart of our mission. At EuroLegal, we specialize in
        ...
        <div class="row px-5">
            <div class="col-md-12">
                <div class="container-fluid py-5 px-4 mt-4 shadow ml-4" style="border:3px solid #1d3f73!important;">
                    ...
                    <div class="d-flex">
                        <div class="col">
                            <h4 class="pt-2 px-2 pb-2 " style=" font-family: PT Sans, sans-serif;">At EuroLegal, we simplify the UK Family Visa process with expert guidance tailored to your circumstances Our services include:</h4>
                            <div class="row ">
                                <div class="col-md-6">
                                    <ul>
                                        <li class="py-2"><h5>	Eligibility assessments to determine the best visa type for you.</h5>

                                        </li>
                                        <li class="py-2"><h5>Assistance with gathering and submitting required documents. </h5>

                                        </li>
                                        <li class="py-2"><h5>Detailed guidance on meeting financial and English language requirements.</h5>
                                            <ul>
                                ...
                                <div class="col-md-6">
                                <ul>
                                    <li class="py-2"><h5> Support throughout the application process, including tracking and updates.</h5>

                                    </li>
                                    <li class="py-2"><h5>Preparation for any interviews or additional document requests from the UK Home Office.</h5>
            ...
            <section class="cta mb-5 shadow-lg rounded " style="background: url('{{asset('frontend/icons-images/cta.jpg')}}') center/cover no-repeat;">
                <div class="cta-content ">
                    <div class="cta-text">
                        ...
                        <p style="color: #efefef !important;">Bring your family together in the UK. Book a consultation for your family visa today!.</p>
                    </div>
